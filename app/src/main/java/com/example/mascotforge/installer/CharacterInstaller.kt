    ...
    companion object {
        fun fromSecurityException(e: SecurityException): CharacterInstallException {
            ...
            val message = when {
                ...
                code == ZipSecurityValidator.ERR_ANY_OF_NOT_OBJECT -> "speechRules の anyOf はオブジェクトである必要があります。"
                code == ZipSecurityValidator.ERR_ANY_OF_VALUE_TYPE -> "anyOf の値は文字列または文字列配列で指定してください。"
                code == ZipSecurityValidator.ERR_ANY_OF_EMPTY_ARRAY -> "anyOf の配列は1件以上の文字列を指定してください。"
